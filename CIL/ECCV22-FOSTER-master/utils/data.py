...
class iImageNet1000(iData):
    ...
    def download_data(self):
        ...
        train_dset = datasets.ImageFolder(data_path + train_dir)
        test_dset = datasets.ImageFolder(data_path + test_dir)
...
class iImageNet100(iData):
    ...
    def download_data(self):
        ...
        data_path = "/gs/home/izhw1024/Code/ECCV22-FOSTER-master/data/imagenet100"
        train_dir = '/train/'
        test_dir = '/val/'
        train_dset = datasets.ImageFolder(data_path + train_dir)
        test_dset = datasets.ImageFolder(data_path + test_dir)
