...
from utils.transform import train_transform, query_transform, Onehot, encode_onehot
import cv2 as cv
...
class ImagenetDataset(Dataset):
    ...
    def __init__(self, root, transform=None, target_transform=None):
        ...
        for file in self.data:
            self.data2Tensor.append(cv.imread(file))
        self.data2Tensor = np.array(self.data2Tensor)
